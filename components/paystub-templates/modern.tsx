                        ...
                        <>
                          ...
                          {(data.overtimeHours && data.overtimeHours > 0) ? (
                            <tr>
                              ...
                              <td className="border border-gray-400 p-1 bg-white text-right">{data.overtimeHours}</td>
